...
vim.keymap.set("n", "<leader>je", "<cmd>JupyniumStopSync<CR>")
vim.keymap.set("n", "<leader>jd", "<cmd>JupyniumDownloadIpynb<CR>")
vim.keymap.set("n", "<leader>jx", "<cmd>JupyniumExecuteSelectedCells<CR>")
